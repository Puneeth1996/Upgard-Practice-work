...
/**
 * The VersionedStringFile implements the VersionedFile interface and makes use
 * of the {@link com.upgrad.dsa.stacks.versioningsystem.VersioningService} to
 * maintain file versions.
 *
 * This class uses the
 * {@link com.upgrad.dsa.stacks.versioningsystem.file.StringFile} as the
 * concrete implementation to store files.
 */
public class VersionedStringFile implements VersionedFile {

    /**
     * Instance of the versioning service, that is used to maintain the different
